...
description: Essential training for ArcAO Ambassadors
sidebar_position: 1
---
...
Welcome to the official ArcAO Ambassador Training program. This comprehensive guide will equip you with the knowledge, skills, and resources needed to effectively represent ArcAO across global communities.

**The goal of this training program is to get you up to speed on ArcAO and all of the projects it encompasses.** To succeed in your ambassador missions, you'll need a strong understanding of each project in the ecosystem.
...
- **Mission & Vision**: Understand ArcAO's role in the GameFi revolution
- **Financial Operations**: Understand how ArcAO operates financially
...
RANDAO is a core technology within the ArcAO ecosystem. As an Ambassador, you should understand:
...
Learn more:
- <a href={ARCAO.website} target="_blank">RANDAO Website</a>
- <a href={ARCAO.theOnchainRandomnessProblem} target="_blank">The On-chain Randomness Problem</a>
...
For each ArcAO game, you should understand:
...
- Create viral content that brings attention to ArcAO projects
- Drive high engagement and discussion around ArcAO
...
- Quarterly strategy sessions with the ArcAO team
...
Remember: Your work doesn't just impact the amount of rewards you receive—it influences their worth. The more people interested in ArcAO projects, the greater the value of what you earn.
...
*Remember: As an ArcAO Ambassador, you're not just promoting games — you're helping shape the future of gaming itself.*

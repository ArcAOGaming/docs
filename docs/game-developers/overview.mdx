...
Welcome to **Arc** — the AAA Game Development DAO where innovation meets decentralization.

---

## 🕹️ 1. Play the Games

Understand what sets Arc apart by playing our flagship titles:
...
- 💬 Join the <a href={ARCAO.discord} target="_blank">Arc Discord</a> to connect with fellow developers  
- 🐦 Follow <a href={ARCAO.twitter} target="_blank">@Arc_AO on Twitter</a> for updates and inspiration

Arc brings together developers, gamers, creators, and investors — all united by a mission to reshape gaming through community.
...
- 🧰 Integrate via the [Arc SDK](./arcao-sdk.mdx) for smooth Permaweb support  
- 🤖 Utilize **Arc AI** to enhance your workflow and productivity  
...
Bring your vision to life with Arc’s community-backed funding ecosystem:
